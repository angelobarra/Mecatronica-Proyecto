...
module main #(
 ...
 parameter v7a6e95 = 0,
 parameter v9e0c41 = 2,
 parameter vd3a244 = "vd3a244.list",
 parameter v180851 = 240000-1,
 parameter v324fd3 = "v324fd3.list"
) (
 input v2312e5,
 input vb00a45,
 input vclk,
 ...
 localparam p0 = v180851;
 localparam p7 = v107eb5;
 localparam p8 = v7a6e95;
 localparam p9 = v9e0c41;
 localparam p13 = v324fd3;
 localparam p19 = vd3a244;
 wire [0:19] w1;
 wire [0:19] w2;
 wire w3;
 wire w4;
...
//-- mi-tabla2-20 CLONE
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- Circuito combinacional de 2 entradas y 20 salidas
//---------------------------------------------------

module v14fb4c_v361fe9 #(
 parameter DATA = 0
) (
 input [1:0] i,
 output [19:0] q
